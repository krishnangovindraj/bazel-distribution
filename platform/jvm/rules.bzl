...
load("//common:rules.bzl", _assemble_zip = "assemble_zip", _java_deps = "java_deps")
...
_assemble_zip_to_jvm_platform = rule(
    attrs = {
        ...
        "_assemble_jvm_platform_bin": attr.label(
            default = "//platform/jvm:assembler-bin",
            executable = True,
            cfg = "exec",
        ),
    },
...
def native_jdk17():
    return select({
        "//platform:is_linux_arm64": "@jdk17_linux_arm64//file",
        "//platform:is_linux_x86_64": "@jdk17_linux_x86_64//file",
        "//platform:is_mac_arm64": "@jdk17_mac_arm64//file",
        "//platform:is_mac_x86_64": "@jdk17_mac_x86_64//file",
        "//platform:is_windows_x86_64": "@jdk17_windows_x86_64//file",
    })
...
def assemble_jvm_platform(name,
    ...
    _assemble_zip_to_jvm_platform(
        ...
        windows_wix_toolset = select({
            "//platform:is_windows": windows_wix_toolset,
            "//conditions:default": None,
        }),
    )
