...
load("//common/java_deps:rules.bzl", _java_deps = "java_deps")
load("//common/tgz2zip:rules.bzl", _tgz2zip = "tgz2zip")
load("//common/targz:rules.bzl", _assemble_targz = "assemble_targz")
load("//common/workspace_refs:rules.bzl", _workspace_refs = "workspace_refs")
load("//common/zip:rules.bzl", _assemble_zip = "assemble_zip", _unzip_file = "unzip_file")
load("//common/rename:rules.bzl", _file_rename = "file_rename")
